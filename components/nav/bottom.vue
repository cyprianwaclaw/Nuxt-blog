<template>
  <div class="absolute">
    <div
    class="md:hidden px-2 py-2.5  border-t border-gray-200 fixed left-0 bottom-0 z-20 grid grid-cols-4 w-full  bg-white justify-items-center"
    >
    <div
...
<div class="md:grid grid-cols-4 cursor-default hidden">
  ...
  <div class="flex flex-col mr-[50px]">
    ...
    <div class="flex flex-col mr-[50px]">
      <h5 class="mb-[10px]">Moje konto</h5>
      <LinkHover
    ...
    <div class="flex flex-col w-full h-full bg-[#F8F8F8]"></div>
  </div>
</template>
...
const MobileBottomNav = [
  { name: "Główna", link: "/", icon_active: "ph:house-duotone", icon: "ph:house-light" },
  {
    name: "Artykuły",
    link: "/post/nowy",
    icon_active: "ph:newspaper-duotone",
    icon: "ph:newspaper-light",
  },
  {
    name: "Zapisane",
    link: "/post/nowy",
    icon_active: "ph:bookmarks-duotone",
